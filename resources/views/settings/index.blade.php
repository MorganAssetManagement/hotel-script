                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                        ...
                                        <h6 class="heading-small text-muted mb-4">{{ __('Social Links') }}</h6>
                                            ...
                                            @include('partials.input',['id'=>'TripAdvisor','name'=>'TripAdvisor','placeholder'=>'TripAdvisor link here ...','value'=>$settings->TripAdvisor, 'required'=>false])
                                            @include('partials.input',['id'=>'GoogleReview','name'=>'GoogleReview','placeholder'=>'Google Review link here ...','value'=>$settings->GoogleReview, 'required'=>false])
                                              <br/>
