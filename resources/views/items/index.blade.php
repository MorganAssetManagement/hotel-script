                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-12">
                                <div class="row">
                                    <div class="col">
                                        <h3 class="mb-0">{{ __('Restaurant Menu Management') }} @if(config('settings.enable_miltilanguage_menus')) ({{ $currentLanguage}}) @endif
                                            @if(Auth::user()->show_price == 1)
                                                <a href="{{ route('toggle-price', ['value' => 0]) }}">
                                                    <button style="float:right; margin-top: -10" class="btn btn-primary">Hide Price</button>
                                                </a>
                                            @else
                                                <a href="{{ route('toggle-price', ['value' => 1]) }}">
