...
<div class="row">
    <div class="col-md-6">
        @include('partials.input',['type'=>"number", 'name'=>'Table limit','id'=>"limit_tables",'placeholder'=>"Number of Tables",'required'=>false,'value'=>(isset($plan)?$plan->limit_tables:null)])
    </div>
   
        <div class="col-md-6">
            @include('partials.input',['name'=>'Staff limit','id'=>"limit_staff",'placeholder'=>"Number of Staff",'required'=>false,'value'=>(isset($plan)?$plan->limit_staff:null)])
        </div>
</div>
<div class="row">
    <div class="col-md-6">
