...
class SettingsController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $settings->TripAdvisor = strip_tags($request->TripAdvisor) ? strip_tags($request->TripAdvisor) : '';
        $settings->GoogleReview = strip_tags($request->GoogleReview) ? strip_tags($request->GoogleReview) : '';
    ...
    public function landing(){
        ...
        $sections = ["Features", "Testimonials", "Processes"];
