                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-12">
                                <div class="row">
                                    <div class="col">
                                        <h3 class="mb-0"><?php echo e(__('Restaurant Menu Management')); ?> <?php if(config('settings.enable_miltilanguage_menus')): ?> (<?php echo e($currentLanguage); ?>) <?php endif; ?>
                                            <?php if(Auth::user()->show_price == 1): ?>
                                                <a href="<?php echo e(route('toggle-price', ['value' => 0])); ?>">
                                                    <button style="float:right; margin-top: -10" class="btn btn-primary">Hide Price</button>
                                                </a>
                                            <?php else: ?>
                                                <a href="<?php echo e(route('toggle-price', ['value' => 1])); ?>">
                                                    <button style="float:right;  margin-top: -10" class="btn btn-danger">Show Price</button>
                                                </a>
                                            <?php endif; ?> </h3> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', ['title' => __('Restaurant Menu Management')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\khan\Downloads\app (3)\resources\views/items/index.blade.php ENDPATH**/ ?>