                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                        ...
                                        <h6 class="heading-small text-muted mb-4"><?php echo e(__('Social Links')); ?></h6>
                                            ...
                                            <?php echo $__env->make('partials.input',['id'=>'TripAdvisor','name'=>'TripAdvisor','placeholder'=>'TripAdvisor link here ...','value'=>$settings->TripAdvisor, 'required'=>false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            <?php echo $__env->make('partials.input',['id'=>'GoogleReview','name'=>'GoogleReview','placeholder'=>'Google Review link here ...','value'=>$settings->GoogleReview, 'required'=>false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                              <br/>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', ['title' => __('Settings')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\khan\Downloads\app (3)\resources\views/settings/index.blade.php ENDPATH**/ ?>