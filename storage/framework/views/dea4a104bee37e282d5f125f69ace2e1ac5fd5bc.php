        ...
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <div class="pl-lg-4">
                        <form method="post" action="<?php echo e(route('plans.store')); ?>" autocomplete="off" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', ['title' => __('Plan')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\khan\Downloads\app (3)\resources\views/plans/create.blade.php ENDPATH**/ ?>