...
<div class="row">
    <div class="col-md-6">
        <?php echo $__env->make('partials.input',['type'=>"number", 'name'=>'Table limit','id'=>"limit_tables",'placeholder'=>"Number of Tables",'required'=>false,'value'=>(isset($plan)?$plan->limit_tables:null)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
   
        <div class="col-md-6">
            <?php echo $__env->make('partials.input',['name'=>'Staff limit','id'=>"limit_staff",'placeholder'=>"Number of Staff",'required'=>false,'value'=>(isset($plan)?$plan->limit_staff:null)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
</div>
<div class="row">
    <div class="col-md-6">
...
<?php /**PATH C:\Users\khan\Downloads\app (3)\resources\views/plans/form.blade.php ENDPATH**/ ?>